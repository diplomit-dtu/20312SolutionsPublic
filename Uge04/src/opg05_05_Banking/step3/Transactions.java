...
package opg05_05_Banking.step3;
...
public class Transactions
{
   ...
   {
      Account acct1 = new Account("Ted Murphy", 72354,  new Address("Foo St", "Software City", "Javaland", 1337));
      Account acct2 = new Account("Jane Smith", 69713,  new Address("Bar St", "Software City", "Javaland", 1337)) ;
      Account acct3 = new Account("Edward Demsey", 93757,  new Address("Hello St", "Software City", "Javaland", 1337));
